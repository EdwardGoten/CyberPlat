...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.as_view(template_name='tournaments/logged_out.html'), name='logout'),
    ...
    path('teams/<int:team_id>/transfer-captain/<int:player_id>/', views.transfer_captaincy, name='transfer_captaincy'),
    ...
    path('tournaments/<int:tournament_id>/complete/', views.complete_tournament_view, name='complete_tournament'),
